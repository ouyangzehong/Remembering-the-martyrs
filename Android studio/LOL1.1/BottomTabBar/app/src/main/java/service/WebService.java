...
public class WebService {
    ...
    //static String IP="http://10.101.136.62:8021/WebService1.asmx/";
    ...
    public static String wpGetqifu() {
        String result="";
        //要提交的目标地址
        String target=IP+"GetQifu";
        String params = "";
        return post(target,params);
    }
    //插入祈福
    public static String wpInsertVerseInfo(String ID, String Tel,String TheOne, String TheTwo, String TheThree, String Adress, String Photostring) {
        //要提交的目标地址
        String target=IP+"InsertVerseinfo";
        String params = "ID="+ URLEncoder.encode(ID);
        params += "&Tel="+URLEncoder.encode(Tel);
        params += "&TheOne="+URLEncoder.encode(TheOne);
        params += "&TheTwo="+URLEncoder.encode(TheTwo);
        params += "&TheThree="+URLEncoder.encode(TheThree);
        params += "&Adress="+URLEncoder.encode(Adress);
        params += "&Photostring="+URLEncoder.encode(Photostring);
        return post(target,params);
    }
}
