...
public class LOLPersonalWebService {
    ...
    //不通过id获取个人信息表的部分信息
    public static String LOLGetsomeUserInfo() {
        String result="";
        //要提交的目标地址
    ...
    //获取账号密码
    public static String LOLGetAll()
    {
        String result="";
        //要提交的目标地址
        String target=IP+"GetAll";
        String params = "";
        return post(target,params);
    }

    //获取许愿墙信息
    public static String LOLGetQifu() {
        String result="";
        //要提交的目标地址
    ...
    public static String LOLGetTelNumber() {
        String result="";
        //要提交的目标地址
        String target=IP+"GetTelNumber";
        String params = "";
        return post(target,params);
    }
}
