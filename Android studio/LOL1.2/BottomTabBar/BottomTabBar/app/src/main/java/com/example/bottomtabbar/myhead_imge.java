...
public class myhead_imge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent !=null)
        {
            ...
            name1.setText(intent.getStringExtra("username"));
        ...
        btnPicture.setOnClickListener(listenerPhoto);
        //提交按钮
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                t=new Thread(new Runnable() {
                    public void run() {
                        result=PersonalService.OOLUpdateHeadByUserName(username,headimg);
    ...
    private android.view.View.OnClickListener listenerPhoto=new android.view.View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent intent=new Intent(); //创建Intent对象
            Button button=(Button)v; //将View强制转换为Button对象
